...
// `DriftAccessor` specifies the following class is a DAO class for the
// `DriftRecipe` table.
...
class RecipeDao extends DatabaseAccessor<RecipeDatabase> with _$RecipeDaoMixin {
  ...
  /// Drift 객체가 아니라 Dart 객체로 변환해서 모든 레시피들을 이벤트로 방출.
  Stream<List<Recipe>> watchAllRecipes() {
    return select(driftRecipe).watch().map((List<DriftRecipeData> rows) {
